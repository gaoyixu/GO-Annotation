# An implementation of multi-source attention in encoder side
        ...
        for iter in range(1, pairLen + 1):
            ...
            if step < 3:
                ...
                loss = train(input_tensors, target_tensor, encoder, decoder,CombineEncoder,
                 encoder_optimizer1, decoder_optimizer1,CombineEncoder_optimizer1, criterion, iter)
            # elif i < n_epoch*0.6:
                # loss = train(input_tensors, target_tensor, encoder, decoder, CombineEncoder,
            #     #              encoder_optimizer2, decoder_optimizer2, CombineEncoder_optimizer2, criterion)
                ...
                loss = train(input_tensors, target_tensor, encoder, decoder, CombineEncoder,
                            encoder_optimizer2, decoder_optimizer2, CombineEncoder_optimizer2, criterion, iter)
...
encoder_save_path = "model/MSAEncoder+" +nowTime+ "hidden"+str(hidden_size)+ "+.pth"
decoder_save_path = "model/MSADecoder+" +nowTime+ "hidden"+str(hidden_size)+ "+.pth"
combiner_save_path = "model/MSACombiner+" +nowTime+ "hidden"+str(hidden_size)+ "+.pth"
